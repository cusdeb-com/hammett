...
This demo demonstrates how an error handler manages different exception types and how error handling behavior changes depending on the source of the error. Check out the [documentation](https://cusdeb-com.github.io/hammett) for more details.

See the live demo [here](https://t.me/HammettErrorHandlerBot).
...
First, navigate to the `demos/error_handler_bot/` directory:

```bash
$ cd demos/error_handler_bot/
```

Next, create and activate a virtual environment:

```bash
$ virtualenv -p python3 error-handler-bot-env
$ source ./error-handler-bot-env/bin/activate
```
...
```bash
$ docker compose up --build -d error-handler-bot
```
