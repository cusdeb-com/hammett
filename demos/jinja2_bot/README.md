...
This demo shows how to use **Jinja2 templates** in Hammett screens. It demonstrates rendering dynamic text using variables and loops, with demo data loaded from a JSON file and displayed automatically. Check out the [documentation](https://cusdeb-com.github.io/hammett) for more details.

See the live demo [here](https://t.me/HammettJinja2Bot).
...
First, navigate to the `demos/jinja2_bot/` directory:
...
```bash
$ virtualenv -p python3 jinja2-bot-env
$ source ./jinja2-bot-env/bin/activate
```
...
```bash
$ docker compose up --build -d jinja2-bot
```
